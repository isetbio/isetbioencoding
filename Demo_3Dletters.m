...
thisSE.set('asset', letterC, 'material name', 'White_glossy');
thisSE.set('n bounces',4);

thisSE.set('asset','001_Wall_O','material name','wood001');
thisSE.set('asset','001_Ground_O','material name','wood002');

[scene, status] = thisSE.render('render type','radiance'); 
sceneWindow(scene);

% piAssetGeometry(thisSE.recipe);
% thisSE.recipe.show('objects');
% thisSE.recipe.get('print lights');
% thisSE.recipe.show('objects');
